...
public class Gallery2TRY extends Gallery_MAIN {
	...
	public  void Tests_Gallery_imageOfChosenVariation() throws Exception {
		...
		String variation1_image = act.elementAttText(ElementsBuying.Product_variationsColor_1_imgSelected, "src", driver);
		
		act.waitForAttributeChange(ElementsBuying.Product_galleryImage, "src", gallery_image, driver);
		gallery_image = act.elementAttText(ElementsBuying.Product_variationsColor_1_img, "src", driver);
	...
	public  void Tests_Gallery_imageOfChangedVariation() throws Exception {
		...
		String variation2_image = act.elementAttText(ElementsBuying.Product_variationsColor_2_imgSelected, "src", driver);

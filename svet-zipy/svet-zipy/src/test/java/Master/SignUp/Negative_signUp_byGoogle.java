...
public class Negative_signUp_byGoogle extends signUp_MAIN {
	
	
	//tests with parameters 
	@RunWith(Parameterized.class)
	public static class Negative_Tests_signUp_byGoogle_parameterized extends signUp_MAIN  {	
	...
	public static class Negative_Tests_signUp_byGoogle_notParameterized extends signUp_MAIN {
